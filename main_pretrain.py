...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument("--data_path", default="./coco", type=str, help="dataset path")

    parser.add_argument("--output_dir", default="./mae_result", help="path where to save, empty for no saving")
    parser.add_argument("--log_dir", default="./mae_result/logs", help="path where to tensorboard log")
...
def main(args):
    ...
    # dataset_train = datasets.ImageFolder(os.path.join(args.data_path, "image_data"), transform=transform_train)
    #cocoデータセットに対応させる
    dataset_train = CocoDetection(
        root=os.path.join(args.data_path, "train2017"),
        annFile=os.path.join(args.data_path, "annotations/instances_train2017.json"),
